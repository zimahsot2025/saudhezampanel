...
echo -e "${BLUE}│${YELLOW}                  saudhezam.com                    ${NC}"
echo -e "${BLUE}│${CYAN}               Created by Saud Hezam               ${NC}"
echo -e "${BLUE}│                                                    ${NC}"
...
echo -e "${BLUE}│${GREEN}            https://ko-fi.com/saudhezam             ${NC}"
echo -e "${BLUE}│                                                    ${NC}"
echo -e "${BLUE}│${CYAN}          EasycPanel v4.1 - Enhanced               ${NC}"
echo -e "${BLUE}└──────────────────────────────────────────────────┘${NC}"
